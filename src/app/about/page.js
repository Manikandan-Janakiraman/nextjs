        ...
        <>
            ...
            <div className="flex flex-row p-30 gap-5 justify-around min-h-screen">
                ...
                <div className="w-200 h-125 text-black flex flex-col gap-2 p-3 rounded-xl">
                    ...
                    <h1 className="font-bold text-5xl">About the World</h1>
                    <p>
                    ...
                    <p>
                        Quality and hygiene are at the core of everything we do. We ensure the every meal prepared by our chefs follows proper safety standards and maintains consistent taste and freshness. Our goal is to build trust with every order, so customers can enjoy their food without any concerns.
